...
class Harvests(models.Model):
    ...
    # NOTE: editable=True allows frontend to provide IDs (offline-first approach)
    # Backend accepts frontend-generated IDs or auto-generates as fallback
    harvest_id = models.CharField(
        max_length=20,
        unique=True,
        editable=True,  # Changed from False to allow frontend-generated IDs
        primary_key=True,
